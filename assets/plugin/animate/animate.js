...
//            el.classList.add(this.options.animatedClass);
            var animationCompletedClass = el.getAttribute('data-animation-classes').split(' ');
            var addCompletedAnimation = function(animation) {
                    el.classList.add(animation);
                };

            // aDD each animation from element
            animationCompletedClass.forEach(addCompletedAnimation);
//            el.classList.add(animationCompletedClass);
